          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header d-flex align-items-center pt-0 pb-0">
                <h3 class="h4 col-md-6 pl-0 tab-title">App Notifications</h3>
				<div class="col-md-6 text-right pr-0">
				<button type="button" class="btn btn-add btn-xs" id="myBtn" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus mr-1"></i> Add APP Notification</button>
				</div>
              </div>
		    ...
		    <tbody>
								...
								?>
                                  <tr>
									...
									<td><?php if($notificationlist['image']){ ?><img width="100px" height="100px" src="<?= Yii::$app->request->baseUrl.'/uploads/notificationimage/'.$notificationlist['image'];?>" alt="" ><?php }?></td>
...
<div class="modal-dialog modal-xl" >
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Edit APP Notification</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
