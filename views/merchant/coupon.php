          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header d-flex align-items-center pt-0 pb-0">
				...
				<button type="button" class="btn btn-add btn-xs" id="myBtn" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus mr-1"></i> Add Coupon</button>
...
<td>
						...
						<span class="slider round"></span> 
											...
											<td class="icons"><a  onclick="editcoupon('<?= $couponModel['ID']?>');"><span class="fa fa-pencil"></span></a></td>										
...
<div class="col-md-4">
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'fromdate')->textinput(['class' => 'form-control datepicker1','placeholder'=>'Validity From'])->label(false); ?>
	   </div></div>
	   </div>
...
<div class="col-md-4">
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'todate')->textinput(['class' => 'form-control datepicker2','placeholder'=>'Validity Yo'])->label(false); ?>
	   </div></div>
	   </div>
