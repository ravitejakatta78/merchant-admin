...
<div class="col-md-6">	
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'title')->textinput(['class' => 'form-control title','autocomplete'=>'off','placeholder'=>'Product Name'])->label(false); ?>
	   </div>
	   </div>
	   <div class="form-group row">
	   <label class="control-label col-md-4">Product Tag</label>
	   <div class="col-md-8">
			      <?= $form->field($model, 'labeltag')->textinput(['class' => 'form-control labeltag','placeholder'=>'Product Tag'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
...
<div class="col-md-6">
	   ...
	   <div class="col-md-8">
				  ...
				  ->where(['merchant_id'=>Yii::$app->user->identity->ID])->all(), 'ID', 'food_category')
				  ,['prompt'=>'Select',
                    'onchange'=>'
	   ...
	   <div class="modal-footer">
		<?= Html::submitButton('Add Product', ['class'=> 'btn btn-add']); ?>
