...
<div class="col-md-6">	
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'email')->textinput(['class' => 'form-control','placeholder'=>'Enter Mail id'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
	   <label class="control-label col-md-4">Select Type</label>	 
		<div class="col-md-8">	   
	   			      <?= $form->field($model, 'storetype')
				  ->dropdownlist(['Restaurant'=>'Restaurant','Theatre'=>'Theatre']
				  )->label(false); ?>
	   </div></div>
	   <div class="form-group row">
...
<div class="col-md-6">
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'storename')->textinput(['class' => 'form-control','placeholder'=>'Enter Store Name'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
	   ...
	   <div class="col-md-8">
				...
				<div class="col-md-4">
					<div class="view view-tenth">
						<img id="logopreview" src="<?= Yii::$app->request->baseUrl.'/uploads/merchantimages/'.$model->logo;?>" />
				...
				<div class="col-md-4">
					<div class="view view-tenth">
						<img id="qrlogopreview" src="<?= Yii::$app->request->baseUrl.'/uploads/merchantimages/'.$model->qrlogo;?>" />
						<div class="mask col-md-12">
							<div class="row">
								<div class="col-md-12">
				...
				<div class="col-md-4">
                <div class="view view-tenth">
					<img id="coverpicpreview" src="<?= Yii::$app->request->baseUrl.'/uploads/merchantimages/'.$model->coverpic;?>" />
  				    <div class="mask col-md-12">
						<div class="row">
							<div class="col-md-12">
